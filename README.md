Данный проект создает тестовую версию бд CRM-системы позволяющей отследить путь лида от просмотра рекламы до конверсии в покупку в виде подписки на платный телеграм канал.
